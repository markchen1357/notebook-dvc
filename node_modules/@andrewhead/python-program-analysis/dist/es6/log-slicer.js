...
var ExecutionLogSlicer = /** @class */ (function () {
    ...
    ExecutionLogSlicer.prototype.sliceAllExecutions = function (cellId, seedLocations) {
        ...
        return this.executionLog
            ...
            // Slice the program
            var sliceLocations = slice(program.tree, adjustedSeedLocations, _this.dataflowAnalyzer).items.sort(function (loc1, loc2) { return loc1.first_line - loc2.first_line; });
            ...
            var cellSlices = cellOrder.map(function (sliceCell) {
                return new CellSlice(sliceCell, cellSliceLocations[sliceCell.executionEventId], cellExecutionTimes[sliceCell.executionEventId]);
            });
    ...
    ExecutionLogSlicer.prototype.getDependentCells = function (executionEventId) {
        ...
        var seedLocations = new (LocationSet.bind.apply(LocationSet, [void 0].concat(lines.items.map(function (line) { return ({
            first_line: line,
            first_column: 0,
            last_line: line,
            last_column: 1
