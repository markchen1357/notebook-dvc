...
describe("slice", function () {
    ...
    it("does our current demo", function () {
        ...
        [1, 2, 3, 4, 5, 7, 8].forEach(function (line) { return expect(lineNums).toContain(line); });
    ...
    it("uses api specs to decide mutating methods", function () {
        ...
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 2, 3, 5].forEach(function (line) { return expect(lineNums).toContain(line); });
    ...
    it("joins inferred types", function () {
        ...
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 2, 3, 4, 5, 6, 7, 9].forEach(function (line) { return expect(lineNums).toContain(line); });
    ...
    it("does the documentation example", function () {
        ...
        var locations = slice(ast, criterion, da);
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 3, 4, 6].forEach(function (line) { return expect(lineNums).toContain(line); });
        [2, 5].forEach(function (line) { return expect(lineNums).not.toContain(line); });
    });
    it("eliminates functions without side-effects", function () {
        ...
        var locations = slice(ast, criterion, da);
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [3, 5, 6].forEach(function (line) { return expect(lineNums).toContain(line); });
        [1, 2, 4].forEach(function (line) { return expect(lineNums).not.toContain(line); });
    });
    it("keeps functions with item updates", function () {
        ...
        var locations = slice(ast, criterion, da);
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 3, 4, 5, 6].forEach(function (line) { return expect(lineNums).toContain(line); });
    });
    it("keeps functions with field updates", function () {
        ...
        var locations = slice(ast, criterion, da);
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 3, 7, 8, 10, 11].forEach(function (line) { return expect(lineNums).toContain(line); });
        [5, 9].forEach(function (line) { return expect(lineNums).not.toContain(line); });
    });
    it("handles transitive updates", function () {
        ...
        var locations = slice(ast, criterion, new DataflowAnalyzer());
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 2, 3, 5, 6].forEach(function (line) { return expect(lineNums).toContain(line); });
    });
    it("does jim's demo", function () {
        ...
        var locations = slice(ast, criterion, new DataflowAnalyzer());
        var lineNums = locations.items.map(function (loc) { return loc.first_line; });
        [1, 2, 3, 7].forEach(function (line) { return expect(lineNums).toContain(line); });
        [4, 5, 6].forEach(function (line) { return expect(lineNums).not.toContain(line); });
    });
});
